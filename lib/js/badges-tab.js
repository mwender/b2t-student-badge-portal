...
(function($){
  ...
  if( '' != wpvars.student_id ){
    var studentDataURL = wpvars.jsonurl + 'getStudentBadges/?student_id=' + wpvars.student_id + '&security=' + wpvars.nonce;
    $.ajax({
      url: studentDataURL,
      type: 'GET',
      dataType: 'json',
  ...
  $('#badge-display, #certificate-display').on('click', '.add-to-backpack', function(e){
    ...
    console.info('wpvars.assertionurl = ', url);

    navigator.clipboard.writeText(url);
    alert(
      "Your badge is ready! Click OK to copy the Badge URL to your clipboard.\n\n" +
