...
(function($){
  ...
  if( '' != wpvars.student_id ){
    var studentDataURL = wpvars.jsonurl + 'getStudentData/?student_id=' + wpvars.student_id + '&security=' + wpvars.nonce;
    //var studentDataURL = wpvars.jsonurl + 'getStudentData/';
    console.log('studentDataURL: ' + studentDataURL);
    $.ajax({
      url: studentDataURL,
      type: 'GET',
      dataType: 'json',
      /*data: {student_id: wpvars.student_id, security: wpvars.nonce},*/
  ...
  $('#badge-display, #certificate-display').on('click', '.add-to-backpack', function(e){
    ...
    url = wpvars.assertionurl + '?email=' + wpvars.student_email + '&badge=' + badge + '&completed=' + dateString;
    console.log(url);
